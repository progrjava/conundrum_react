...
const ThemeChanger = ({isBlackTheme, toggleTheme, page}) => {
    return (
        <div id={`${page ? 'game-theme-changer' : ''}`} className='theme-changer'>
            <svg id={`${page ? 'game-black-theme-switch' : ''}`} className='black-theme-switch' onClick={() => toggleTheme(true)} xmlns="http://www.w3.org/2000/svg" viewBox='0 0 32 32' fill="none">
            ...
            <svg id={`${page ? 'game-white-theme-switch' : ''}`} className='white-theme-switch' onClick={() => toggleTheme(false)}  xmlns="http://www.w3.org/2000/svg" viewBox='0 0 32 32' fill="none">
