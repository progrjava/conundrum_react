    ...
    render() {
        ...
        return (
            <div className='theme-changer'>
                <svg className='black-theme-switch' onClick={() => toggleTheme(true)} xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none">
                ...
                <svg className='white-theme-switch' onClick={() => toggleTheme(false)}  xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="none">
